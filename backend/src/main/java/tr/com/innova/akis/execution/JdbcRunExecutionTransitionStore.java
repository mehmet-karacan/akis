                ...
                select exists (
                    select 1
                     ...
                     where c.uuid = :runUuid
                       ...
                       and (select count(*) from entegrasyon.calistirma_adimi ca
