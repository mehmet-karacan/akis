    ...
    public Optional<ConnectionProfile> find(DatasetBinding binding) {
        ...
        return jdbc.sql("""
                        select distinct p.uuid as project_uuid,
                               ...
                               b.baglanti_modu,
                               b.jndi_adi,
                               b.surucu_sinifi as surucu_referansi,
                               b.sunucu_adi,
                               case when b.saglayici_turu = 'ORACLE' then b.servis_adi else b.veritabani_adi end as servis_adi,
                               b.sid,
                               b.port,
                               'DISABLED' as tls_modu,
                               jsonb_build_object(
                                  'connectTimeoutMs',b.baglanti_zaman_asimi_ms,
                                  'readTimeoutMs',b.okuma_zaman_asimi_ms,
                                  'networkTimeoutMs',b.okuma_zaman_asimi_ms,
                                  'queryTimeoutSeconds',b.sorgu_zaman_asimi_saniye) as politika,
                               case when b.baglanti_modu = 'JNDI' then null else 'TABLO' end as saglayici_kodu,
                               b.sifre as referans_yolu
                         ...
                         where tvn.uuid = :definitionDataObjectUuid
                           ...
                           and b.durum = 'ETKIN'
                           and fs.durum = 'ETKIN'
                           and (b.baglanti_modu = 'JNDI' or b.sifre is not null)
