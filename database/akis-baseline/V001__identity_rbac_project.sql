...
CREATE TABLE yetki (
    ...
    CONSTRAINT uq_yetki_id_kapsam UNIQUE (id, kapsam),
...
CREATE TABLE rol_yetki (
    ...
    CONSTRAINT fk_rol_yetki_rol
        FOREIGN KEY (rol_id, kapsam) REFERENCES rol(id, kapsam),
    CONSTRAINT fk_rol_yetki_yetki
        FOREIGN KEY (yetki_id, kapsam) REFERENCES yetki(id, kapsam),
    CONSTRAINT ck_rol_yetki_kapsam CHECK (kapsam IN ('SISTEM', 'PROJE')),
...
CREATE TABLE proje_uyeligi (
    ...
    gecerlilik_baslangici TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT ck_proje_uyeligi_gecerlilik CHECK (
        gecerlilik_sonu IS NULL OR gecerlilik_sonu >= gecerlilik_baslangici
    ),
...
SELECT r.id, y.id, r.kapsam
  ...
  JOIN yetki y ON y.kod = a.yetki_kodu AND y.kapsam = r.kapsam;
