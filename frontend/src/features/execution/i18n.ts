...
const en = {
  ...
  expandStep: 'Expand step', collapseStep: 'Collapse step', executionRoot: 'Execution', selectedRows: 'Rows Selected', insertedRows: 'Rows Inserted', notRecorded: 'Not recorded', resumeHelp: 'Continues from the failed step; work already sealed in the staging table is adopted, not reloaded.', resumeStarted: 'Attempt #{{number}} started from the failed step.', restartStarted: 'Attempt #{{number}} started from the beginning.', reconciledFirst: 'Target reconciliation: {{message}}', resumeUnavailable: 'Resume is not available for this run: {{reason}}', reconcileFailed: 'Target reconciliation could not be completed; resume was not started.', sourceCommand: 'Source Command', targetCommand: 'Target Command', commandSql: 'Executed SQL', sqlUnavailable: 'The published command text could not be loaded.', openChildRun: 'Open the step run', packageStep: 'Package step', releaseTarget: 'Release target', releaseTargetTitle: 'Release the quarantined target', releaseTargetHelp: 'The target was quarantined because reconciliation found conflicting publication evidence. Releasing it lets new runs fence the target again; this run closes as failed. Check the target table first and record why.', releaseReason: 'Reason', releaseTargetDone: 'Target released; new runs may use it.', confirmRelease: 'Release',
