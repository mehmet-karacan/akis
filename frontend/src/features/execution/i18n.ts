...
const codeLabels: Record<'en' | 'tr', Record<string, string>> = {
  en: { MANUAL: 'Manual', SCHEDULED: 'Scheduled', API: 'API', PROSEDUR: 'Procedure', PROCEDURE: 'Procedure', MAPPING: 'Data flow', PAKET: 'Package', PACKAGE: 'Package', VARIABLE: 'Variable', SEQUENCE: 'Sequence', KNOWLEDGE_MODULE: 'Execution module', LOAD_PLAN: 'Load plan', URETIM: 'Production', TEST: 'Test', GELISTIRME: 'Development', SOURCE: 'Source', TARGET: 'Target', SQL: 'SQL', TRUNCATE: 'Truncate', INSERT: 'Insert', GATHER_STATS: 'Gather statistics' },
  tr: { MANUAL: 'Manuel', SCHEDULED: 'Zamanlanmış', API: 'API', PROSEDUR: 'Prosedür', PROCEDURE: 'Prosedür', MAPPING: 'Veri Akışı', PAKET: 'Paket', PACKAGE: 'Paket', VARIABLE: 'Değişken', SEQUENCE: 'Sıra üretici', KNOWLEDGE_MODULE: 'Yürütme modülü', LOAD_PLAN: 'Yükleme planı', URETIM: 'Üretim', TEST: 'Test', GELISTIRME: 'Geliştirme', SOURCE: 'Kaynak', TARGET: 'Hedef', SQL: 'SQL', TRUNCATE: 'Tabloyu boşalt', INSERT: 'Veri ekle', GATHER_STATS: 'İstatistikleri topla' },
}
