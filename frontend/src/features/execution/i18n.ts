...
const en = {
  ...
  keepRun: 'Keep run', confirm: 'Cancel run', jobRequestUuid: 'Job request UUID', runUuid: 'Run UUID', publicationUuid: 'Publication UUID', planHash: 'Plan hash', cancellationRequestedAt: 'Cancellation requested',
...
const tr: Record<keyof typeof en, string> = {
  ...
  keepRun: 'Çalıştırmayı koru', confirm: 'Çalıştırmayı iptal et', jobRequestUuid: 'İş talebi UUID', runUuid: 'Çalıştırma UUID', publicationUuid: 'Yayın UUID', planHash: 'Plan özeti', cancellationRequestedAt: 'İptal talebi',
