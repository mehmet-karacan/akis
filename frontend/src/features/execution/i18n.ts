...
const en = {
  ...
  expandStep: 'Expand step', collapseStep: 'Collapse step', executionRoot: 'Execution', selectedRows: 'Rows Selected', insertedRows: 'Rows Inserted', notRecorded: 'Not recorded', sourceCommand: 'Source Command', targetCommand: 'Target Command', commandSql: 'Executed SQL', sqlUnavailable: 'The published command text could not be loaded.',
...
const tr: Record<keyof typeof en, string> = {
  ...
  expandStep: 'Adımı genişlet', collapseStep: 'Adımı daralt', executionRoot: 'Çalıştırma', selectedRows: 'Kaynaktan Seçilen Satır', insertedRows: 'Hedefe Eklenen Satır', notRecorded: 'Kaydedilmedi', sourceCommand: 'Kaynak Komutu', targetCommand: 'Hedef Komutu', commandSql: 'Çalışan SQL', sqlUnavailable: 'Yayınlanan komut metni yüklenemedi.',
