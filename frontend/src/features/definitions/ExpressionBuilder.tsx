...
export function expressionSummary(expression?: Expression): string | null {
  ...
  const summarize = (node: unknown, depth: number): string | null => {
    ...
    try { return mappingSqlText(item, {}) } catch { return null }
  }
