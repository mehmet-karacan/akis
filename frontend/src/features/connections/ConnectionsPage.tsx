...
export function ConnectionsPage() {
  ...
  const labels = { host: i18n.language === 'tr' ? 'Sunucu' : 'Host', port: 'Port', service: i18n.language === 'tr' ? 'Servis Adı veya SID' : 'Service Name or SID', username: i18n.language === 'tr' ? 'Kullanıcı Adı' : 'Username', provider: t('connections.provider'), connection: t('connections.connection'), endpoint: t('connections.endpoint'), physical: t('connections.physicalShort'), logical: t('connections.logicalShort'), status: t('connections.status'), lastTest: i18n.language === 'tr' ? 'Son Test Zamanı' : 'Last Tested', actions: t('connections.actions'), open: t('connections.open'), ready: t('connections.ready'), testRequired: t('connections.testRequired') }
