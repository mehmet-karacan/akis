...
import { AsyncState, Button, Dialog, PageHeader, StatusBadge, SummaryStrip } from '../../core/ui'
...
export function ModelsPage() {
  ...
  async function create(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setOpen(false); setNotice(t('common.savedSuccessfully')); await load()
  ...
  return <section className="page-stack models-page"><FeedbackToast message={notice} onClose={closeNotice} />
    ...
    <QueryFilter onApply={setQuery} placeholder={t('models.searchPlaceholder')} />
    ...
    <SummaryStrip ariaLabel={t('models.title')} items={[
      { label: t('models.title'), value: models.length, icon: <Layers3 />, tone: 'info' },
